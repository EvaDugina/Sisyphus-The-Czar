...
До первого захвата работает сцена «кошки-мышки»: первые два входа мыши в радиус гарантированно заставляют камень ускакивать от курсора, третий пропускается, а последующие входы используют настраиваемую вероятность несрабатывания `0–100%`. Дистанция зависит от скорости указателя и максимума `0–150%`, а длительность — от заданной скорости камня `100–5000 px/s` и cubic-bezier-кривой. Первые N фейковых кликов открывают центрированное окно с `ВЗГЛЯД.jpg`, отталкивают камень и не запускают физику; следующий клик активирует сцену 2. После активации повторный захват снизу возвращает камень к начальному размеру, а camera-follow плавно прокручивает страницу только вверх вслед за ним.
