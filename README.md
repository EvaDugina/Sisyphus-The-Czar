...
В сцене 2 включённый пульс работает до первого захвата, после выпадения и после приземления, но останавливается на время сжатия камня рукой. Настройка «Звук клика по камню» поддерживает `Без звука`. После фактического выпадения runtime снимает sticky-защёлку, поэтому камень можно снова захватить; обычный pointerup по-прежнему не размыкает текущий захват.
