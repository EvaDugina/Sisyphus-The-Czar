...
export const SETTINGS_GROUPS = [
  ...
  },
  {
    ...
    controls: [
      ...
      {
        name: "rainAudioEnterMs",
        label: "Звук: появление, мс",
        type: "number",
        min: 0,
        max: 10000,
        step: 50,
        defaultValue: DEFAULT_ROOM_SETTINGS.rainAudioEnterMs,
        output: String(DEFAULT_ROOM_SETTINGS.rainAudioEnterMs),
        hint: "Сколько миллисекунд звук дождя плавно набирает громкость после включения. Ноль — сразу целевая громкость.",
      },
      {
        name: "rainAudioExitMs",
        label: "Звук: затухание, мс",
        type: "number",
        min: 0,
        max: 10000,
        step: 50,
        defaultValue: DEFAULT_ROOM_SETTINGS.rainAudioExitMs,
        output: String(DEFAULT_ROOM_SETTINGS.rainAudioExitMs),
        hint: "Сколько миллисекунд звук дождя плавно затихает перед остановкой. Ноль — мгновенная остановка.",
      },
    ],
  },
];
