...
export function useSisyphusExperience(sceneId) {
  ...
  const trail = {
    ...
    rockEchoTrailLayerRef: useRef(null),
  };
  const rain = {
  ...
  useEffect(() => {
    const runtime = createSisyphusRuntime({
      ...
      rockLensCanvas: rockLensCanvasRef.current,
      ...
      rockEchoTrailLayer: rockEchoTrailLayerRef.current,
