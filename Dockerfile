...
RUN mkdir -p /app/data /app/repository-config && chown -R node:node /app
...
RUN mkdir -p /app/data /app/repository-config && chown node:node /app/data /app/repository-config
